...
#define AI_NET_OBJ_INSTANCE g_flowers
 
#undef AI_FLOWERS_MODEL_SIGNATURE
#define AI_FLOWERS_MODEL_SIGNATURE     "a45c3466b49dde80e98e339ba5d2083a"
...
#define AI_TOOLS_DATE_TIME   "Mon Feb  5 11:31:03 2024"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_FLOWERS_N_BATCHES
#define AI_FLOWERS_N_BATCHES         (1)

static ai_ptr g_flowers_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_flowers_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_STATIC_CONST ai_i32 nl_69_nl_params_data[] = { 1421939328, 23, -248 };
AI_ARRAY_OBJ_DECLARE(
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    229888, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FLOWERS_IN_NUM, &serving_default_input_10_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FLOWERS_OUT_NUM, &conversion_70_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool flowers_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_flowers_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    serving_default_input_10_output_array.data = AI_PTR(g_flowers_activations_map[0] + 23124);
    serving_default_input_10_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 23124);
    
    conversion_0_output_array.data = AI_PTR(g_flowers_activations_map[0] + 23120);
    conversion_0_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 23120);
    
    conv2d_1_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 72276);
    conv2d_1_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 72276);
    
    conv2d_1_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 5696);
    conv2d_1_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 5696);
    
    conv2d_1_output_array.data = AI_PTR(g_flowers_activations_map[0] + 5696);
    conv2d_1_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 5696);
    
    conv2d_2_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 1536);
    conv2d_2_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 1536);
    
    conv2d_2_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 71232);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 71232);
    
    conv2d_2_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 512);
    conv2d_2_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 512);
    
    conv2d_2_output_array.data = AI_PTR(g_flowers_activations_map[0] + 512);
    conv2d_2_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 512);
    
    conv2d_3_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 66048);
    conv2d_3_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 66048);
    
    conv2d_3_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_3_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_4_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 32768);
    conv2d_4_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 32768);
    
    conv2d_4_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 33280);
    conv2d_4_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 33280);
    
    conv2d_4_output_array.data = AI_PTR(g_flowers_activations_map[0] + 33280);
    conv2d_4_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 33280);
    
    conv2d_6_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 27088);
    conv2d_6_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 27088);
    
    conv2d_6_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_6_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_6_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 25552);
    conv2d_6_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 25552);
    
    conv2d_6_output_array.data = AI_PTR(g_flowers_activations_map[0] + 25552);
    conv2d_6_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 25552);
    
    conv2d_7_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_7_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_7_output_array.data = AI_PTR(g_flowers_activations_map[0] + 272);
    conv2d_7_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 272);
    
    conv2d_8_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 8464);
    conv2d_8_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8464);
    
    conv2d_8_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 8976);
    conv2d_8_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8976);
    
    conv2d_8_output_array.data = AI_PTR(g_flowers_activations_map[0] + 58128);
    conv2d_8_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 58128);
    
    conv2d_9_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 107280);
    conv2d_9_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 107280);
    
    conv2d_9_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 8464);
    conv2d_9_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8464);
    
    conv2d_9_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 10244);
    conv2d_9_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 10244);
    
    conv2d_9_output_array.data = AI_PTR(g_flowers_activations_map[0] + 162768);
    conv2d_9_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 162768);
    
    conv2d_10_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_10_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_10_output_array.data = AI_PTR(g_flowers_activations_map[0] + 8464);
    conv2d_10_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8464);
    
    eltwise_11_output_array.data = AI_PTR(g_flowers_activations_map[0] + 16656);
    eltwise_11_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 16656);
    
    conv2d_12_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_12_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_12_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 24848);
    conv2d_12_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 24848);
    
    conv2d_12_output_array.data = AI_PTR(g_flowers_activations_map[0] + 74000);
    conv2d_12_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 74000);
    
    conv2d_14_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_14_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_14_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 52272);
    conv2d_14_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 52272);
    
    conv2d_14_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 54052);
    conv2d_14_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 54052);
    
    conv2d_14_output_array.data = AI_PTR(g_flowers_activations_map[0] + 66340);
    conv2d_14_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 66340);
    
    conv2d_15_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_15_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_15_output_array.data = AI_PTR(g_flowers_activations_map[0] + 352);
    conv2d_15_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 352);
    
    conv2d_16_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 4448);
    conv2d_16_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4448);
    
    conv2d_16_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 5472);
    conv2d_16_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 5472);
    
    conv2d_16_output_array.data = AI_PTR(g_flowers_activations_map[0] + 30048);
    conv2d_16_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 30048);
    
    conv2d_17_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 54624);
    conv2d_17_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 54624);
    
    conv2d_17_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 4448);
    conv2d_17_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4448);
    
    conv2d_17_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 8004);
    conv2d_17_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8004);
    
    conv2d_17_output_array.data = AI_PTR(g_flowers_activations_map[0] + 85728);
    conv2d_17_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 85728);
    
    conv2d_18_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 4448);
    conv2d_18_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4448);
    
    conv2d_18_output_array.data = AI_PTR(g_flowers_activations_map[0] + 4992);
    conv2d_18_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4992);
    
    eltwise_19_output_array.data = AI_PTR(g_flowers_activations_map[0] + 9088);
    eltwise_19_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 9088);
    
    conv2d_20_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_20_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_20_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 13184);
    conv2d_20_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 13184);
    
    conv2d_20_output_array.data = AI_PTR(g_flowers_activations_map[0] + 37760);
    conv2d_20_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 37760);
    
    conv2d_21_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 62336);
    conv2d_21_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 62336);
    
    conv2d_21_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_21_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_21_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 13184);
    conv2d_21_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 13184);
    
    conv2d_21_output_array.data = AI_PTR(g_flowers_activations_map[0] + 37760);
    conv2d_21_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 37760);
    
    conv2d_22_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_22_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_22_output_array.data = AI_PTR(g_flowers_activations_map[0] + 544);
    conv2d_22_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 544);
    
    eltwise_23_output_array.data = AI_PTR(g_flowers_activations_map[0] + 4640);
    eltwise_23_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4640);
    
    conv2d_24_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_24_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_24_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 8736);
    conv2d_24_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8736);
    
    conv2d_24_output_array.data = AI_PTR(g_flowers_activations_map[0] + 33312);
    conv2d_24_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 33312);
    
    conv2d_26_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_26_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_26_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 27744);
    conv2d_26_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 27744);
    
    conv2d_26_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 31300);
    conv2d_26_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 31300);
    
    conv2d_26_output_array.data = AI_PTR(g_flowers_activations_map[0] + 37444);
    conv2d_26_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 37444);
    
    conv2d_27_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_27_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_27_output_array.data = AI_PTR(g_flowers_activations_map[0] + 624);
    conv2d_27_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 624);
    
    conv2d_28_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2160);
    conv2d_28_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2160);
    
    conv2d_28_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 3696);
    conv2d_28_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3696);
    
    conv2d_28_output_array.data = AI_PTR(g_flowers_activations_map[0] + 12912);
    conv2d_28_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 12912);
    
    conv2d_29_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 22128);
    conv2d_29_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 22128);
    
    conv2d_29_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2160);
    conv2d_29_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2160);
    
    conv2d_29_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 7492);
    conv2d_29_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 7492);
    
    conv2d_29_output_array.data = AI_PTR(g_flowers_activations_map[0] + 36528);
    conv2d_29_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 36528);
    
    conv2d_30_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2160);
    conv2d_30_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2160);
    
    conv2d_30_output_array.data = AI_PTR(g_flowers_activations_map[0] + 2976);
    conv2d_30_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2976);
    
    eltwise_31_output_array.data = AI_PTR(g_flowers_activations_map[0] + 4512);
    eltwise_31_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4512);
    
    conv2d_32_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_32_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_32_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 6048);
    conv2d_32_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 6048);
    
    conv2d_32_output_array.data = AI_PTR(g_flowers_activations_map[0] + 15264);
    conv2d_32_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 15264);
    
    conv2d_33_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 24480);
    conv2d_33_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 24480);
    
    conv2d_33_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 6048);
    conv2d_33_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 6048);
    
    conv2d_33_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 11380);
    conv2d_33_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 11380);
    
    conv2d_33_output_array.data = AI_PTR(g_flowers_activations_map[0] + 38880);
    conv2d_33_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 38880);
    
    conv2d_34_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_34_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_34_output_array.data = AI_PTR(g_flowers_activations_map[0] + 816);
    conv2d_34_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 816);
    
    eltwise_35_output_array.data = AI_PTR(g_flowers_activations_map[0] + 2352);
    eltwise_35_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2352);
    
    conv2d_36_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_36_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_36_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 3888);
    conv2d_36_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3888);
    
    conv2d_36_output_array.data = AI_PTR(g_flowers_activations_map[0] + 13104);
    conv2d_36_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 13104);
    
    conv2d_37_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 22320);
    conv2d_37_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 22320);
    
    conv2d_37_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 3888);
    conv2d_37_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3888);
    
    conv2d_37_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 9220);
    conv2d_37_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 9220);
    
    conv2d_37_output_array.data = AI_PTR(g_flowers_activations_map[0] + 36720);
    conv2d_37_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 36720);
    
    conv2d_38_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_38_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_38_output_array.data = AI_PTR(g_flowers_activations_map[0] + 816);
    conv2d_38_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 816);
    
    eltwise_39_output_array.data = AI_PTR(g_flowers_activations_map[0] + 3888);
    eltwise_39_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3888);
    
    conv2d_40_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_40_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_40_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 5424);
    conv2d_40_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 5424);
    
    conv2d_40_output_array.data = AI_PTR(g_flowers_activations_map[0] + 14640);
    conv2d_40_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 14640);
    
    conv2d_41_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_41_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_41_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 14400);
    conv2d_41_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 14400);
    
    conv2d_41_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 19732);
    conv2d_41_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 19732);
    
    conv2d_41_output_array.data = AI_PTR(g_flowers_activations_map[0] + 28948);
    conv2d_41_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 28948);
    
    conv2d_42_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_42_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_42_output_array.data = AI_PTR(g_flowers_activations_map[0] + 896);
    conv2d_42_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 896);
    
    conv2d_43_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2944);
    conv2d_43_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2944);
    
    conv2d_43_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 4992);
    conv2d_43_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4992);
    
    conv2d_43_output_array.data = AI_PTR(g_flowers_activations_map[0] + 17280);
    conv2d_43_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 17280);
    
    conv2d_44_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 29568);
    conv2d_44_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 29568);
    
    conv2d_44_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2944);
    conv2d_44_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2944);
    
    conv2d_44_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 10052);
    conv2d_44_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 10052);
    
    conv2d_44_output_array.data = AI_PTR(g_flowers_activations_map[0] + 48768);
    conv2d_44_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 48768);
    
    conv2d_45_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2944);
    conv2d_45_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2944);
    
    conv2d_45_output_array.data = AI_PTR(g_flowers_activations_map[0] + 4032);
    conv2d_45_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4032);
    
    eltwise_46_output_array.data = AI_PTR(g_flowers_activations_map[0] + 6080);
    eltwise_46_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 6080);
    
    conv2d_47_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_47_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_47_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 8128);
    conv2d_47_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8128);
    
    conv2d_47_output_array.data = AI_PTR(g_flowers_activations_map[0] + 20416);
    conv2d_47_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 20416);
    
    conv2d_48_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 32704);
    conv2d_48_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 32704);
    
    conv2d_48_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 8128);
    conv2d_48_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 8128);
    
    conv2d_48_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 15236);
    conv2d_48_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 15236);
    
    conv2d_48_output_array.data = AI_PTR(g_flowers_activations_map[0] + 51904);
    conv2d_48_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 51904);
    
    conv2d_49_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_49_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_49_output_array.data = AI_PTR(g_flowers_activations_map[0] + 1088);
    conv2d_49_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 1088);
    
    eltwise_50_output_array.data = AI_PTR(g_flowers_activations_map[0] + 3136);
    eltwise_50_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3136);
    
    conv2d_51_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_51_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_51_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 5184);
    conv2d_51_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 5184);
    
    conv2d_51_output_array.data = AI_PTR(g_flowers_activations_map[0] + 17472);
    conv2d_51_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 17472);
    
    conv2d_53_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_53_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_53_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 15552);
    conv2d_53_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 15552);
    
    conv2d_53_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 22660);
    conv2d_53_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 22660);
    
    conv2d_53_output_array.data = AI_PTR(g_flowers_activations_map[0] + 25732);
    conv2d_53_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 25732);
    
    conv2d_54_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_54_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_54_output_array.data = AI_PTR(g_flowers_activations_map[0] + 1328);
    conv2d_54_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 1328);
    
    conv2d_55_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2224);
    conv2d_55_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2224);
    
    conv2d_55_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 5808);
    conv2d_55_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 5808);
    
    conv2d_55_output_array.data = AI_PTR(g_flowers_activations_map[0] + 11184);
    conv2d_55_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 11184);
    
    conv2d_56_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 16560);
    conv2d_56_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 16560);
    
    conv2d_56_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2224);
    conv2d_56_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2224);
    
    conv2d_56_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 28656);
    conv2d_56_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 28656);
    
    conv2d_56_output_array.data = AI_PTR(g_flowers_activations_map[0] + 34032);
    conv2d_56_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 34032);
    
    conv2d_57_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 2224);
    conv2d_57_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2224);
    
    conv2d_57_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_57_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    eltwise_58_output_array.data = AI_PTR(g_flowers_activations_map[0] + 2224);
    eltwise_58_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2224);
    
    conv2d_59_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 3120);
    conv2d_59_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3120);
    
    conv2d_59_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 6704);
    conv2d_59_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 6704);
    
    conv2d_59_output_array.data = AI_PTR(g_flowers_activations_map[0] + 12080);
    conv2d_59_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 12080);
    
    conv2d_60_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 17456);
    conv2d_60_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 17456);
    
    conv2d_60_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 3120);
    conv2d_60_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3120);
    
    conv2d_60_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 29552);
    conv2d_60_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 29552);
    
    conv2d_60_output_array.data = AI_PTR(g_flowers_activations_map[0] + 34928);
    conv2d_60_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 34928);
    
    conv2d_61_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_61_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_61_output_array.data = AI_PTR(g_flowers_activations_map[0] + 3120);
    conv2d_61_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3120);
    
    eltwise_62_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    eltwise_62_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_63_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 896);
    conv2d_63_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 896);
    
    conv2d_63_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 4480);
    conv2d_63_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4480);
    
    conv2d_63_output_array.data = AI_PTR(g_flowers_activations_map[0] + 9856);
    conv2d_63_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 9856);
    
    conv2d_64_pad_before_output_array.data = AI_PTR(g_flowers_activations_map[0] + 15232);
    conv2d_64_pad_before_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 15232);
    
    conv2d_64_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_64_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_64_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 27328);
    conv2d_64_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 27328);
    
    conv2d_64_output_array.data = AI_PTR(g_flowers_activations_map[0] + 32704);
    conv2d_64_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 32704);
    
    conv2d_65_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conv2d_65_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    conv2d_65_output_array.data = AI_PTR(g_flowers_activations_map[0] + 2464);
    conv2d_65_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 2464);
    
    conv2d_66_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 4256);
    conv2d_66_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 4256);
    
    conv2d_66_scratch1_array.data = AI_PTR(g_flowers_activations_map[0] + 17504);
    conv2d_66_scratch1_array.data_start = AI_PTR(g_flowers_activations_map[0] + 17504);
    
    conv2d_66_output_array.data = AI_PTR(g_flowers_activations_map[0] + 37984);
    conv2d_66_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 37984);
    
    pool_67_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    pool_67_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    gemm_68_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 1280);
    gemm_68_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 1280);
    
    gemm_68_output_array.data = AI_PTR(g_flowers_activations_map[0] + 3840);
    gemm_68_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 3840);
    
    nl_69_scratch0_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    nl_69_scratch0_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
    
    nl_69_output_array.data = AI_PTR(g_flowers_activations_map[0] + 20);
    nl_69_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 20);
    
    conversion_70_output_array.data = AI_PTR(g_flowers_activations_map[0] + 0);
    conversion_70_output_array.data_start = AI_PTR(g_flowers_activations_map[0] + 0);
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool flowers_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_flowers_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    conv2d_1_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 0);
    conv2d_1_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 0);
    
    conv2d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 432);
    conv2d_1_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 432);
    
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 496);
    conv2d_2_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 496);
    
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 640);
    conv2d_2_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 640);
    
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 704);
    conv2d_3_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 704);
    
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 832);
    conv2d_3_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 832);
    
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 864);
    conv2d_4_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 864);
    
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 1248);
    conv2d_4_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 1248);
    
    conv2d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 1440);
    conv2d_6_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 1440);
    
    conv2d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 1872);
    conv2d_6_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 1872);
    
    conv2d_7_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 2064);
    conv2d_7_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 2064);
    
    conv2d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 2448);
    conv2d_7_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 2448);
    
    conv2d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 2480);
    conv2d_8_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 2480);
    
    conv2d_8_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 2864);
    conv2d_8_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 2864);
    
    conv2d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 3056);
    conv2d_9_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 3056);
    
    conv2d_9_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 3488);
    conv2d_9_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 3488);
    
    conv2d_10_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_10_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 3680);
    conv2d_10_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 3680);
    
    conv2d_10_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_10_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 4064);
    conv2d_10_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 4064);
    
    conv2d_12_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 4096);
    conv2d_12_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 4096);
    
    conv2d_12_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 4480);
    conv2d_12_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 4480);
    
    conv2d_14_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_14_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 4672);
    conv2d_14_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 4672);
    
    conv2d_14_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_14_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 5104);
    conv2d_14_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 5104);
    
    conv2d_15_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_15_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 5296);
    conv2d_15_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 5296);
    
    conv2d_15_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_15_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 6064);
    conv2d_15_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 6064);
    
    conv2d_16_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_16_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 6128);
    conv2d_16_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 6128);
    
    conv2d_16_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_16_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 7664);
    conv2d_16_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 7664);
    
    conv2d_17_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_17_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 8048);
    conv2d_17_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 8048);
    
    conv2d_17_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_17_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 8912);
    conv2d_17_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 8912);
    
    conv2d_18_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_18_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 9296);
    conv2d_18_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 9296);
    
    conv2d_18_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_18_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 10832);
    conv2d_18_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 10832);
    
    conv2d_20_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_20_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 10896);
    conv2d_20_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 10896);
    
    conv2d_20_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_20_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 12432);
    conv2d_20_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 12432);
    
    conv2d_21_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_21_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 12816);
    conv2d_21_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 12816);
    
    conv2d_21_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_21_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 13680);
    conv2d_21_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 13680);
    
    conv2d_22_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_22_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 14064);
    conv2d_22_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 14064);
    
    conv2d_22_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_22_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 15600);
    conv2d_22_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 15600);
    
    conv2d_24_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_24_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 15664);
    conv2d_24_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 15664);
    
    conv2d_24_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_24_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 17200);
    conv2d_24_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 17200);
    
    conv2d_26_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_26_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 17584);
    conv2d_26_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 17584);
    
    conv2d_26_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_26_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 18448);
    conv2d_26_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 18448);
    
    conv2d_27_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_27_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 18832);
    conv2d_27_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 18832);
    
    conv2d_27_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_27_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 21136);
    conv2d_27_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 21136);
    
    conv2d_28_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_28_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 21232);
    conv2d_28_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 21232);
    
    conv2d_28_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_28_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 24688);
    conv2d_28_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 24688);
    
    conv2d_29_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_29_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 25264);
    conv2d_29_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 25264);
    
    conv2d_29_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_29_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 26560);
    conv2d_29_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 26560);
    
    conv2d_30_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_30_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 27136);
    conv2d_30_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 27136);
    
    conv2d_30_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_30_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 30592);
    conv2d_30_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 30592);
    
    conv2d_32_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_32_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 30688);
    conv2d_32_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 30688);
    
    conv2d_32_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_32_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 34144);
    conv2d_32_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 34144);
    
    conv2d_33_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_33_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 34720);
    conv2d_33_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 34720);
    
    conv2d_33_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_33_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 36016);
    conv2d_33_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 36016);
    
    conv2d_34_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_34_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 36592);
    conv2d_34_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 36592);
    
    conv2d_34_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_34_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 40048);
    conv2d_34_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 40048);
    
    conv2d_36_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_36_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 40144);
    conv2d_36_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 40144);
    
    conv2d_36_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_36_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 43600);
    conv2d_36_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 43600);
    
    conv2d_37_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_37_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 44176);
    conv2d_37_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 44176);
    
    conv2d_37_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_37_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 45472);
    conv2d_37_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 45472);
    
    conv2d_38_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_38_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 46048);
    conv2d_38_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 46048);
    
    conv2d_38_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_38_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 49504);
    conv2d_38_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 49504);
    
    conv2d_40_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_40_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 49600);
    conv2d_40_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 49600);
    
    conv2d_40_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_40_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 53056);
    conv2d_40_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 53056);
    
    conv2d_41_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_41_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 53632);
    conv2d_41_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 53632);
    
    conv2d_41_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_41_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 54928);
    conv2d_41_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 54928);
    
    conv2d_42_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_42_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 55504);
    conv2d_42_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 55504);
    
    conv2d_42_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_42_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 60112);
    conv2d_42_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 60112);
    
    conv2d_43_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_43_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 60240);
    conv2d_43_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 60240);
    
    conv2d_43_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_43_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 66384);
    conv2d_43_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 66384);
    
    conv2d_44_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_44_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 67152);
    conv2d_44_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 67152);
    
    conv2d_44_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_44_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 68880);
    conv2d_44_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 68880);
    
    conv2d_45_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_45_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 69648);
    conv2d_45_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 69648);
    
    conv2d_45_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_45_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 75792);
    conv2d_45_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 75792);
    
    conv2d_47_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_47_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 75920);
    conv2d_47_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 75920);
    
    conv2d_47_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_47_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 82064);
    conv2d_47_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 82064);
    
    conv2d_48_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_48_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 82832);
    conv2d_48_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 82832);
    
    conv2d_48_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_48_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 84560);
    conv2d_48_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 84560);
    
    conv2d_49_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_49_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 85328);
    conv2d_49_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 85328);
    
    conv2d_49_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_49_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 91472);
    conv2d_49_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 91472);
    
    conv2d_51_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_51_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 91600);
    conv2d_51_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 91600);
    
    conv2d_51_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_51_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 97744);
    conv2d_51_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 97744);
    
    conv2d_53_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_53_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 98512);
    conv2d_53_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 98512);
    
    conv2d_53_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_53_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 100240);
    conv2d_53_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 100240);
    
    conv2d_54_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_54_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 101008);
    conv2d_54_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 101008);
    
    conv2d_54_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_54_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 111760);
    conv2d_54_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 111760);
    
    conv2d_55_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_55_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 111984);
    conv2d_55_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 111984);
    
    conv2d_55_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_55_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 130800);
    conv2d_55_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 130800);
    
    conv2d_56_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_56_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 132144);
    conv2d_56_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 132144);
    
    conv2d_56_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_56_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 135168);
    conv2d_56_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 135168);
    
    conv2d_57_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_57_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 136512);
    conv2d_57_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 136512);
    
    conv2d_57_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_57_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 155328);
    conv2d_57_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 155328);
    
    conv2d_59_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_59_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 155552);
    conv2d_59_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 155552);
    
    conv2d_59_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_59_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 174368);
    conv2d_59_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 174368);
    
    conv2d_60_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_60_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 175712);
    conv2d_60_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 175712);
    
    conv2d_60_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_60_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 178736);
    conv2d_60_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 178736);
    
    conv2d_61_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_61_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 180080);
    conv2d_61_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 180080);
    
    conv2d_61_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_61_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 198896);
    conv2d_61_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 198896);
    
    conv2d_63_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_63_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 199120);
    conv2d_63_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 199120);
    
    conv2d_63_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_63_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 217936);
    conv2d_63_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 217936);
    
    conv2d_64_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_64_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 219280);
    conv2d_64_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 219280);
    
    conv2d_64_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_64_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 222304);
    conv2d_64_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 222304);
    
    conv2d_65_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_65_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 223648);
    conv2d_65_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 223648);
    
    conv2d_65_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_65_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 261280);
    conv2d_65_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 261280);
    
    conv2d_66_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_66_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 261728);
    conv2d_66_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 261728);
    
    conv2d_66_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_66_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 405088);
    conv2d_66_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 405088);
    
    gemm_68_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_68_weights_array.data = AI_PTR(g_flowers_weights_map[0] + 410208);
    gemm_68_weights_array.data_start = AI_PTR(g_flowers_weights_map[0] + 410208);
    
    gemm_68_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_68_bias_array.data = AI_PTR(g_flowers_weights_map[0] + 416608);
    gemm_68_bias_array.data_start = AI_PTR(g_flowers_weights_map[0] + 416608);
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_FLOWERS_MODEL_NAME,
      .model_signature   = AI_FLOWERS_MODEL_SIGNATURE,
  ...
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ...
    err = ai_flowers_create(network, AI_FLOWERS_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_flowers_data_params_get(&params) != true) {
        err = ai_flowers_get_error(*network);
        return err;
    }
#if defined(AI_FLOWERS_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_FLOWERS_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_flowers_init(*network, &params) != true) {
        err = ai_flowers_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_flowers_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_flowers_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= flowers_configure_weights(net_ctx, params);
  ok &= flowers_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_flowers_forward(ai_handle network, const ai_buffer* input)
{
