...
AI_ALIGNED(32)
static uint8_t pool0[AI_FLOWERS_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_FLOWERS_MODEL_NAME,
        .config = AI_FLOWERS_DATA_CONFIG,
        .ai_get_report = ai_flowers_get_report,
        .ai_create = ai_flowers_create,
        .ai_destroy = ai_flowers_destroy,
        .ai_get_error = ai_flowers_get_error,
        .ai_init = ai_flowers_init,
        .ai_run = ai_flowers_run,
        .ai_forward = ai_flowers_forward,
        .ai_data_params_get = ai_flowers_data_params_get,
