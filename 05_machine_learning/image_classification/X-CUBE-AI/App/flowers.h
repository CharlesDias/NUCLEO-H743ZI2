...
/******************************************************************************/
#define AI_FLOWERS_MODEL_NAME          "flowers"
#define AI_FLOWERS_ORIGIN_MODEL_NAME   "mobilenet_v2_0_35_128_int8"

/******************************************************************************/
#define AI_FLOWERS_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FLOWERS_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FLOWERS_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FLOWERS_IN_NUM        (1)

AI_DEPRECATED
#define AI_FLOWERS_IN \
  ai_flowers_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FLOWERS_IN_SIZE { \
  AI_FLOWERS_IN_1_SIZE, \
}
#define AI_FLOWERS_IN_SIZE_BYTES { \
  AI_FLOWERS_IN_1_SIZE_BYTES, \
}
#define AI_FLOWERS_IN_1_FORMAT      AI_BUFFER_FORMAT_U8
#define AI_FLOWERS_IN_1_HEIGHT      (128)
#define AI_FLOWERS_IN_1_WIDTH       (128)
#define AI_FLOWERS_IN_1_CHANNEL     (3)
#define AI_FLOWERS_IN_1_SIZE        (128 * 128 * 3)
#define AI_FLOWERS_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_FLOWERS_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FLOWERS_OUT \
  ai_flowers_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FLOWERS_OUT_SIZE { \
  AI_FLOWERS_OUT_1_SIZE, \
}
#define AI_FLOWERS_OUT_SIZE_BYTES { \
  AI_FLOWERS_OUT_1_SIZE_BYTES, \
}
#define AI_FLOWERS_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_FLOWERS_OUT_1_CHANNEL     (5)
#define AI_FLOWERS_OUT_1_SIZE        (5)
#define AI_FLOWERS_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_FLOWERS_N_NODES (84)
 ...
 */
AI_API_ENTRY
ai_error ai_flowers_get_error(ai_handle network);
 ...
 * using @ref ai_flowers_get_error
 */
AI_API_ENTRY
ai_bool ai_flowers_init(
 ...
 */
AI_API_ENTRY
ai_error ai_flowers_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_flowers_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_flowers_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FLOWERS_*
 * defines into file @ref flowers.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
